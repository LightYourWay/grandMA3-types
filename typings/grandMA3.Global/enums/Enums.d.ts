...
declare namespace Enums {
	...
	enum AssignmentButtonFunctionsBlind {
		'' = 0,
		'Empty' = 0,
		'On' = 7,
		'Off' = 8,
	...
	enum AssignmentButtonFunctionsGrandMaster {
		'' = 0,
		'Empty' = 0,
		'On' = 7,
		'Off' = 8,
	...
	enum AssignmentButtonFunctionsHighlightSolo {
		'' = 0,
		'Empty' = 0,
		'On' = 7,
		'Off' = 8,
	...
	enum AssignmentButtonFunctionsPlaybackMaster {
		'' = 0,
		'Empty' = 0,
	}
	...
	enum AssignmentButtonFunctionsRate {
		'' = 0,
		'Empty' = 0,
		'On' = 7,
		'Off' = 8,
	...
	enum AssignmentButtonFunctionsSoundMaster {
		'' = 0,
		'Empty' = 0,
		'On' = 7,
		'Off' = 8,
	...
	enum AssignmentButtonFunctionsSpeed {
		'' = 0,
		'Empty' = 0,
		'On' = 7,
		'Off' = 8,
	...
	enum AssignmentButtonFunctionsTag {
		'' = 0,
		'Empty' = 0,
		'Go+' = 3,
		'Go-' = 4,
	...
	enum AssignmentButtonFunctionsTimecode {
		'' = 0,
		'Empty' = 0,
		'Go+' = 3,
		'Go-' = 4,
	...
	enum AssignmentFaderFunctionsPreset____ {
		'' = 0,
		'Empty' = 0,
		'Master' = 35,
		'Temp' = 39,
	...
	enum HardwareButtonDisplayMode {
		'Text+Icon' = 0,
		'Text' = 1,
		'Icon' = 2,
	}
	...
	enum LearnMode {
		'Default' = 0,
		'Learn Respects Speed Scale' = 1,
		'Auto Increase Speed Scale' = 2,
	}
	enum LicenseRequest {
		'Auto' = 0,
		'On' = 1,
	...
	enum MessageCenterRememberedTab {
		'Messages' = 0,
		'Statuses' = 1,
	}
	...
	enum MidiShowControlCommandMode {
		'Extensions' = 0,
		'General Light' = 1,
		'Moving Light' = 2,
		'All' = 127,
	}
	enum MidiShowControlExecMode {
		'Default' = 0,
		'Executor.Page' = 1,
		'Executor Page' = 2,
	}
	enum MidiShowControlRowDisabled {
		'Disabled' = 65535,
	}
	enum MidiShowControlSendTo {
		'Group' = 0,
		'Device' = 1,
		'All' = 2,
	}
	...
	enum PathType {
		...
		'GrandMA3Library' = 53,
		'Keyboards' = 54,
		'KeyboardShortcuts' = 55,
		'Software' = 56,
		'VizLibrary' = 57,
		'MvrLibrary' = 58,
		'DmxCurvesLibrary' = 59,
		'Library' = 60,
		'TemplateShowfiles' = 61,
		'UserMedia' = 62,
		'UserSoundLibrary' = 63,
		'UserVideoLibrary' = 64,
		'UserImageLibrary' = 65,
		...
		'UserDeviceConfig' = 78,
		'UserFixtures' = 79,
		'UserFixtureTypeResources' = 80,
		'UserGobos' = 81,
		'UserMeshes' = 82,
		'UserMeshImages' = 83,
		'UserMaterials' = 84,
		'UserGdtfResources' = 85,
		'UserMvr' = 86,
		'UserUsers' = 87,
		'UserProfiles' = 88,
		'UserViews' = 89,
		'ViewButtonLibrary' = 90,
		'UserCameras' = 91,
		'UserScreenConfigurations' = 92,
		'UserRenderQuality' = 93,
		'UserKeyboardShortcuts' = 94,
		'UserGels' = 95,
		'UserEncoderBars' = 96,
		'UserAgendas' = 97,
		'UserCertificates' = 98,
	...
	enum PhaseRangesValueNone {
		'0 Thru 90°' = -9205357638345293824,
		'0 Thru 180°' = -9187343239835811840,
		'0 Thru 360°' = -9151314442816847872,
		'0 Thru -360°' = -8142508126285856768,
		'0 Thru -180°' = -8106479329266892800,
		'0 Thru -90°' = -8088464930757410816,
		'90°' = 4194304,
		'180°' = 8388608,
		'270°' = 12582912,
		'360°' = 16777216,
	...
	enum PhaserRecipeDirection {
		'Forward' = 0,
		'Backward' = 1,
		'Alternate' = 2,
	}
	enum PhaserRecipeValueSpecials {
		'Release' = 1124073472,
		'ChannelFunctionDefault' = 1124073473,
		'Default' = 1124073474,
		'Highlight' = 1124073475,
		'Lowlight' = 1124073476,
		'Zero' = 1124073477,
		'Full' = 1124073478,
		'None' = 1124073479,
	...
	enum RecipeContextMenu {
		'GridContextNone' = 0,
		'ShapeEditContent' = 4,
		'MatricksEditContent' = 8,
	}
	enum RecipeContextSheet {
		'GridContextSheetSelection' = 3,
		'GridContextSheetValues' = 5,
		'GridContextSheetFilter' = 7,
		'GridContextSheetAttributes' = 9,
	}
	enum RecipePresetReadoutMode {
		'Name' = 0,
		'ID' = 3,
		'ID+Name' = 4,
		'ID+Long Name' = 6,
	}
	enum RecipeStoreMode {
		'Normal' = 0,
		'NoSelection' = 1,
	}
	enum RecordGo {
	...
	enum ResolutionLimit1440p {
		'480p' = 0,
		'720p' = 1,
		'1080p' = 2,
		'1440p' = 3,
	}
	enum ResolutionLimit4k {
		'480p' = 0,
		'720p' = 1,
		'1080p' = 2,
		'1440p' = 3,
	...
	enum UserProfileChildIndex {
		...
		'StorePreferences' = 4,
		'ExecFixation' = 5,
		'SpecialExecPageCollect' = 6,
		'TemporaryWindowSettings' = 7,
		'SmartViewPool' = 8,
		'Variables' = 9,
		'ScreenConfig' = 10,
		'LayoutElementDefaults' = 11,
		'KeyboardShortcutsConfig' = 12,
		'AttributePreferences' = 13,
		'RenderQuality' = 14,
		'GridRegistry' = 15,
		'StatusCenter' = 16,
		'PreviewObjects' = 17,
